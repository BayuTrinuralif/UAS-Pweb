...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Tambahkan Jenis Cuti</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Tambahkan Jenis Cuti</div>
                    </div>
...
<textarea id="textarea1" name="description" class="materialize-textarea" name="description" length="500"></textarea>
                                                <label for="deptshortname">Deskripsi</label>
                                            </div>
...
<div class="input-field col s12">
<button type="submit" name="add" class="waves-effect waves-light btn indigo m-b-xs">Tambahkan</button>
