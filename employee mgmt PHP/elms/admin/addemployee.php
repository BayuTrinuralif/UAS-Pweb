...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Tambahkan Karyawan</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Tambahkan Karyawan</div>
                    </div>
...
<label for="empcode">Kode Karyawan(Seunik Mungkin)</label>
...
<div class="input-field col s12">
<button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">Tambahkan</button>
