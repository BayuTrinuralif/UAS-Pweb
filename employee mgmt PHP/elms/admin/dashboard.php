                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total Karyawan</span>
...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Departemen Yang Terdaftar</span>
    <?php
...
?>                            
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Jenis Cuti Yang Terdaftar</span>
                                    <?php
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">Aplikasi Cuti Terbaru</span>
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th width="200">Nama Karyawan</th>
                                            <th width="120">Jenis Cuti</th>

                                             <th width="180">Tanggal Posting</th>                 
                                            <th>Status</th>
