...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Tambah Department</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Tambah Department</div>
                    </div>
...
<div class="input-field col s12">
<button type="submit" name="add" class="waves-effect waves-light btn indigo m-b-xs">Tambah</button>
